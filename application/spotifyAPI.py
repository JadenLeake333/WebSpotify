import base64
import requests
from application import helper_functions, parseJSON
...
class spotify_api():
    ...
    def track_list(self,data,content_type,token):
        ...
        if content_type == "playlists":
            next_playlist = parseJSON.parse_json.extract_values(data, 'next')
    ...
    def song_analysis(self,track_ids,token):
        ...
        ids = helper_functions.split_list(track_ids,100)
        for id in ids:
